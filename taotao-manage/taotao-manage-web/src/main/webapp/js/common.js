    	...
    	$(".selectItemCat").each(function(i,e){
    		...
    		_ele.unbind('click').click(function(){
    			...
    			.window({
    			    ...
    			    iconCls:'icon-save',
    			    title:'选择类目',
    			    onOpen : function(){//当前窗体打开时触发onOpen事件
    			    	var _win = this;//当前窗体对象
    			    	$("ul",_win).tree({ //异步加载EasyUi tree
    			    		url:'/rest/item/cat',
    			    		method : "GET",
    			    		animate:true,
    			    		onClick : function(node){ //为加载成功的树中的每个节点绑定点击事件
    			    			if($(this).tree("isLeaf",node.target)){
    			    				// 填写到cid中
    			    				//在当前a标签的父级对象中寻找name=cid的元素，并为其赋值=点击树节点的id
